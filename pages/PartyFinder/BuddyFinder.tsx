      ...
      <div>
        <a className={styles.PartyFinder} href='/PartyFinder'>
          <span className={styles.BackArrow}>
            ...
            >
              <path
              className='hover:fill-blue-120 active:fill-blue-90'
          ...
          <span className={styles.SwordCross}>
            <Icon icon="mdi:sword-cross" color="#E2E4E9" width="33" height="33" />
          </span>
          <span>Party Finder</span>
        </a>
        {pageNumber < 6 && <a className={[styles.Next, 'bg-blue-100'].join(' ')} onClick={() => {setPageNumber(pageNumber + 1)}}>Next</a>}
        ...
        {pageNumber != 1 && pageNumber < 6 && <a className={[styles.Back, 'bg-mediumGrey'].join(' ')} style={{left: '38.5rem'}} onClick={() => {setPageNumber(pageNumber - 1)}}>Back</a>}
        {pageNumber === 1 && <a className={[styles.Back, 'bg-mediumGrey'].join(' ')} href='/PartyFinder'>Back</a>}
      </div>
    </div>
  );
}
