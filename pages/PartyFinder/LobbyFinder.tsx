...
export default function LobbyFinder() {
  ...
  return (
    <div className={[styles.LobbyFinderContainer, `theme-${mode} bg-primaryBg`].join(" ")}>
      ...
      <div>
        <a className={styles.PartyFinder} href='/PartyFinder'>
          ...
          <span className={styles.SwordCross}>
            <Icon icon="mdi:sword-cross" color="#FFFFFF" width="33" height="33" />
          </span>
          <span className='text-textColor'>Party Finder</span>
        </a>
      </div>
      <LobbyMemberList />
      <div className={[styles.Chatbox, 'bg-neutralBg'].join(" ")}></div>
    </div>
  );
}
