...
const ViewLobbyDev = () => {
  ...
  return (
    <main>
      ...
      <h1>{lobby ? lobby.name : 'Loading...'}</h1>
              ...
              <ol key={user._id.toString()}>
                ...
                <OnlyIf condition={isHost}>
                  ...
                  <span
                    ...
                    onClick={() => handleKick(user._id.toString())}
                  >
                    Kick
                  </span>
                </OnlyIf>
              ...
              <div className={'bg-mediumGrey p-4 rounded-xl'} key={request._id.toString()}>
                ...
                <OnlyIf condition={isHost}>
                  <div className={'flex gap-2 mt-2'}>
                    <Button onClick={() => handleAccept(request._id.toString())}>Accept</Button>
                    <Button onClick={() => handleDeny(request._id.toString())}>Reject</Button>
                  </div>
                </OnlyIf>
              </div>
            ))}
