...
const GoogleRedirectPage = () => {
  ...
  useEffect(() => {
    ...
    fetch(`/api/auth/google/exchange?code=${searchParams.get("code")}&redirect_uri=http://localhost:3000/login/google`)
      .then(res => {
        if (!res.ok) {
          setError(true);
        }
...
GoogleRedirectPage.getLayout = EmptyLayout.getLayout;
